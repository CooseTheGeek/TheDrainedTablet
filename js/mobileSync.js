// mobileSync.js – DRAINED TABLET ULTIMATE v7.0.0
// Mobile device synchronization: QR code connection, push notifications, remote commands.
...
class MobileSync {
    ...
    loadDevices() {
        const saved = localStorage.getItem('tdl_mobile_devices');
        return saved ? JSON.parse(saved) : [];
    }

    saveDevices() {
        localStorage.setItem('tdl_mobile_devices', JSON.stringify(this.connectedDevices));
    }
                ...
                <div class="mobile-grid">
                    ...
                    <div class="notification-settings">
                        ...
                        <div class="checkbox-item">
                            <label><input type="checkbox" id="notify-joins" checked> Player Joins</label>
                        </div>
                        <div class="checkbox-item">
                            <label><input type="checkbox" id="notify-leaves" checked> Player Leaves</label>
                        </div>
                        <div class="checkbox-item">
                            <label><input type="checkbox" id="notify-events" checked> Server Events</label>
                        </div>
                        <div class="checkbox-item">
                            <label><input type="checkbox" id="notify-raids" checked> Raid Alerts</label>
                        </div>
                        <div class="checkbox-item">
                            <label><input type="checkbox" id="notify-bans" checked> Bans/Kicks</label>
                        </div>
                    ...
                    <div class="mobile-commands">
                        ...
                        <div class="command-item"><code>/players</code> - Online players</div>
                        <div class="command-item"><code>/kick [player]</code> - Kick player</div>
                        <div class="command-item"><code>/ban [player]</code> - Ban player</div>
                        <div class="command-item"><code>/event [name]</code> - Trigger event</div>
                        <div class="command-item"><code>/say [message]</code> - Broadcast</div>
                    </div>
    ...
    renderDevices() {
        ...
        list.innerHTML = this.connectedDevices.map(device => `
...
document.addEventListener('DOMContentLoaded', () => {
    window.mobileSync = new MobileSync();
});