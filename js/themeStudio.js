...
class ThemeStudio {
    ...
    saveThemes() {
        localStorage.setItem('tdl_themes', JSON.stringify(this.themes));
    }
    ...
    createHTML() {
        const tab = document.getElementById('tab-theme');
        if (!tab) return;
                    ...
                    <div class="theme-customizer">
                        ...
                        <div class="customizer-section">
                            ...
                            <div class="layout-options">
                                <label><input type="radio" name="layout" value="compact" checked> Compact</label>
                                <label><input type="radio" name="layout" value="comfortable"> Comfortable</label>
                        ...
                        <div class="customizer-section">
                            ...
                            <div class="icon-style">
                                <label><input type="radio" name="icons" value="default" checked> Default</label>
                                <label><input type="radio" name="icons" value="minimal"> Minimal</label>
                                <label><input type="radio" name="icons" value="colored"> Colored</label>
                            </div>
                        </div>
    ...
    attachEvents() {
        ...
        // Delegate for preset loading and icon selection
    ...
    renderIcons() {
        ...
        let html = '';
        icons.forEach(icon => {
            html += `<div class="icon-item" data-icon="${icon}">${icon}</div>`;
        });
        grid.innerHTML = html;
    }
    ...
    updatePreview() {
        ...
        const accentSpan = preview.querySelector('.preview-accent');
        if (accentSpan) accentSpan.style.color = accent;
    }
    ...
    useIcon(icon) {
        // Would apply icon to selected element (placeholder)
...
document.addEventListener('DOMContentLoaded', () => {
    window.themeStudio = new ThemeStudio();
});