...
// REAL RAID DETECTION - NO MOCK ALERTS
...
class RaidDetector {
    ...
    startMonitoring() {
        ...
        // Check for explosions every 2 seconds
    ...
    async checkForExplosions() {
        ...
        try {
            // This would be actual RCON command to check for recent explosions
            // For now, we'll just listen for events
        } catch (error) {
    ...
    handleExplosiveEvent(event) {
        // This is called when an actual explosive event is detected
        const raid = {
            id: Date.now(),
        ...
        // Keep only last 10 active raids
