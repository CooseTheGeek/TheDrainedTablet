// discordSync.js – DRAINED TABLET ULTIMATE v7.0.0
// Discord integration: webhook notifications, command sync, and role management.
...
class DiscordSync {
    ...
    loadSettings() {
        const saved = localStorage.getItem('tdl_discord_settings');
    ...
    saveSettings() {
        localStorage.setItem('tdl_discord_settings', JSON.stringify(this.settings));
    }
    ...
    createHTML() {
        const tab = document.getElementById('tab-discord');
        if (!tab) return;
                ...
                <div class="discord-grid">
                    ...
                    <div class="discord-section">
                        ...
                        <div class="checkbox-item">
                            <label><input type="checkbox" id="notify-joins" ${this.settings.notifyJoins ? 'checked' : ''}> Player Joins</label>
                        ...
                        <div class="checkbox-item">
                            <label><input type="checkbox" id="notify-leaves" ${this.settings.notifyLeaves ? 'checked' : ''}> Player Leaves</label>
                        ...
                        <div class="checkbox-item">
                            <label><input type="checkbox" id="notify-events" ${this.settings.notifyEvents ? 'checked' : ''}> Server Events</label>
                        ...
                        <div class="checkbox-item">
                            <label><input type="checkbox" id="notify-bans" ${this.settings.notifyBans ? 'checked' : ''}> Bans/Kicks</label>
                        ...
                        <div class="checkbox-item">
                            <label><input type="checkbox" id="notify-raids" ${this.settings.notifyRaids ? 'checked' : ''}> Raid Alerts</label>
                    ...
                    <div class="discord-section">
                        <h3>🤖 COMMANDS</h3>
                        <div class="checkbox-item">
                            <label><input type="checkbox" id="allow-commands" ${this.settings.allowCommands ? 'checked' : ''}> Allow Discord Commands</label>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="command-list">
                            ...
                            <div class="command-item"><code>!players</code> - List online players</div>
                            <div class="command-item"><code>!status</code> - Server status</div>
                            <div class="command-item"><code>!kick [player]</code> - Kick player</div>
                            <div class="command-item"><code>!ban [player]</code> - Ban player</div>
                            <div class="command-item"><code>!say [message]</code> - Broadcast message</div>
                        </div>
                    </div>
    ...
    testWebhook() {
        ...
        // In a real implementation, you'd send a test message via bridge
        setTimeout(() => {
    ...
    resetSettings() {
        if (!confirm('Reset Discord settings?')) return;
        this.settings = {
            webhookUrl: '',
            serverName: 'DRAINED SERVER',
            notifyJoins: true,
