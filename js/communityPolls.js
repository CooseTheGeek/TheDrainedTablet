// communityPolls.js – DRAINED TABLET ULTIMATE v7.0.0
// Community polls: create, vote, view results, manage active/ended polls.
// All original features preserved, now with enhanced UI and persistent storage.
...
class CommunityPolls {
    ...
    loadPolls() {
        const saved = localStorage.getItem('tdl_polls');
        return saved ? JSON.parse(saved) : [];
    }

    savePolls() {
        localStorage.setItem('tdl_polls', JSON.stringify(this.polls));
    }
                    ...
                    <div class="modal-content poll-modal">
                        ...
                        <div class="form-row">
                            ...
                            <div class="checkbox-group">
                                <label><input type="checkbox" id="poll-anonymous" checked> Anonymous</label>
    ...
    savePoll() {
        ...
        const poll = {
            ...
            question,
            options,
            createdBy: AppState.user.username || 'Admin',
...
document.addEventListener('DOMContentLoaded', () => {
    window.communityPolls = new CommunityPolls();
});